...
public class StackCalc extends JPanel {
	...
	public StackCalc()
	{
		...
		for(int r = 0; r < 4; r++)
		{
			for(int c = 0; c < 3; c++)
			{
				...
				if(tracker != 12)
					num.addActionListener(new NumButtonListener(r, c));
				else
	...
	{
		private int myR, myC;
		public NumButtonListener(int r, int c)
		{
			myR = r;
			myC = c;
		}
		...
		public void actionPerformed(ActionEvent e)
		{
			if(calcText.getText().equals("0") || isPressed)
				calcText.setText(nums[myR][myC].getText());
			else
				calcText.setText(calcText.getText() + nums[myR][myC].getText());
